...
Function RetrieveAllHolds {
    if ($LitigationHoldsOnly.IsPresent) {
        ...
        $global:ExportCSVFileName = "C:\O365-Audit\Results\$folderName\LitigationHoldsReport$((Get-Date -format "MMM-dd hh-mm-ss tt").ToString()).csv"
    ...
    elseif ($InPlaceHoldsOnly.IsPresent) {
        $global:ExportCSVFileName = "C:\O365-Audit\Results\$folderName\InPlaceHoldsReport$((Get-Date -format "MMM-dd hh-mm-ss tt").ToString()).csv"
    ...
    elseif ($RetentionHoldsOnly.IsPresent) {
        $global:ExportCSVFileName = "C:\O365-Audit\Results\$folderName\RetentionHoldsReport$((Get-Date -format "MMM-dd hh-mm-ss tt").ToString()).csv"
        ...
        $global:ExportCSVFileName = "C:\O365-Audit\Results\$folderName\AllActiveHoldsReport$((Get-Date -format "MMM-dd hh-mm-ss tt").ToString()).csv"
